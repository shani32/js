...
//4
function funcC() {
   console.log("1");//will print out 2 cause it gets down to the end of the function. to get 1 i can change the name of the function or put function into the first one 
   function funcC() {
...
funcD1();
console.log(d);//i think it return 1 cause of hoisting
function funcD2() {
   var e = 1;
}
funcD2();
console.log(e); //i think will return undefined. if i want to change it i can put consol log inside the inner scope
//6
var f = 1;
function funcE() {
...
funcE();//if ill add here console log it will print undefined. otherwise nothing.
  //if i want both of them to print 1. ill put the var on top of ecerything in global scope